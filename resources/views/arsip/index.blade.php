            ...
            @endif
                    ...
                    <form action="{{ route('cari') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="cari" value="{{ old('cari') }}" required>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('detail',$a->nomor_Surat) }}" class="btn btn-sm btn-primary">Lihat</a>
                                    <a href="{!! route('download', $a->file) !!}" class="btn btn-sm btn-warning">Unduh</a>
                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapus{{$a->nomor_Surat}}">
                                        Hapus
                                    </button>
...
@foreach($arsips as $a)
<!-- Modal -->
<div class="modal fade bd-example-modal-sm" id="hapus{{$a->nomor_Surat}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('hapus',$a->nomor_Surat) }}" class="btn btn-danger">Iya</a>
            </div>
        </div>
    </div>
</div>
